      ...
      <div className="p-5">
        {type === 'clubs' && (
          <>
            ...
            <p className="mb-2" style={{ color: '#ffb100', opacity: 0.9 }}>
              {item.description}
            </p>
            <p className="text-sm mb-1" style={{ color: '#ffb100', opacity: 0.8 }}>
              <strong>Багш:</strong> {item.teacher}
            </p>
            <p className="text-sm" style={{ color: '#ffb100', opacity: 0.8 }}>
              <strong>Цагийн хуваарь:</strong> {item.schedule}
            </p>
            {isExpanded && (
              <div className="mt-4 pt-4 border-t" style={{ borderColor: '#ffb100', opacity: 0.3 }}>
                <p className="text-sm mb-2" style={{ color: '#ffb100', opacity: 0.9 }}>
        ...
        {type === 'calendar' && (
          <>
            ...
            <p className="mb-2 font-semibold" style={{ color: '#ffb100' }}>
              {item.date}
            </p>
            <p className="text-sm mb-1" style={{ color: '#ffb100', opacity: 0.9 }}>
        ...
        {type === 'rules' && (
          <>
            ...
            <p className="mb-2 text-sm" style={{ color: '#ffb100', opacity: 0.9 }}>
              {item.description}
            </p>
            <span
